...
class CustomButtons extends StatelessWidget {
  ...
  const CustomButtons({super.key, required this.currentPage, required this.totalPages, required this.pageController});
  @override
    ...
    if (isLastPage) {
      return Padding(
        ...
        child: ElevatedButton(
          ...
          child: Text(
            "تسجيل الدخول",
            style: context.displayMedium!.copyWith(color: AppColors.naturalLight),
          ),
        ),
      );
    } else {
        ...
        children: [
          SizedBox(width: 8),
           ElevatedButton(
              ...
              child: Text("التالي", style: context.titleMedium!.copyWith(color: Color(0xFFFEFEFE)),),
            ),
