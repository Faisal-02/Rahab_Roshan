  ...
  final List<Map<String, String>> _pages = [
    {
      ...
      'subtext':
          "رياضية وثقافية وحركية وغيرها الكثير، فعاليات متنوعة  تناسب اهتمامات جميع أفراد مجتمع روشن",
    },
    {
      'image': 'assets/images/onboarding2.png',
      'text': "الميدان يا حميدان",
      'subtext':
          " كل البطولات في مكان واحد, اختر بطولتك, \n وخلك جزء من المنافسة",
    },
    {
      'image': 'assets/images/onboarding3.png',
      'text': "  الجوائز بانتظارك  ",
      'subtext':
          "شارك في البطولات, واصعد في الترتيب  \n واحصل على جوائز تعكس تميزك",
    },
  ];
